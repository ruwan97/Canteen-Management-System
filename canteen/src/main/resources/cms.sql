...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 05, 2021 at 01:03 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_item_procedure` (IN `itm_id` VARCHAR(6), IN `itm_name` VARCHAR(255), IN `price` FLOAT(2))  BEGIN
INSERT INTO `item`(`item_id`, `item_name`, `unit_price`) VALUES (itm_id , itm_name, price);
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_item_procedure` (IN `itm_id` VARCHAR(6), IN `itm_name` VARCHAR(255), IN `price` FLOAT(2))  BEGIN
UPDATE `item` 
SET 
`item_id` = itm_id,
`item_name` = itm_name,
...
(30, 'TG0004', 'itm003', 7, 210, '2021-07-02 19:03:00'),
...
('TG0001', 'kalana', 'kalani@gmail.com', '45678', 2, 757852136, '69359294_123733428951676_4231814010980270080_n.jpg'),
...
('adm001', 'dasuni', 'dasun@gmail.com', '12345', 1, 717307044, '69503450_123730928951926_8025183084481609728_n.jpg');
